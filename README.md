# 🙏 Sahyadri Krida Mandal — Official Website & Backend
...
| **About** | Mandal history since 1976, mission, and vision |
...
- Email sent via **Gmail SMTP** (Nodemailer)
  ...
  - **To**: `sahyadrikm.r@gmail.com` & `sahyadrikm.r@gmail.com`
...
```bash
git clone https://github.com/varadkadam26/mmmsahyadrikridamandal.git
cd mmmsahyadrikridamandal
npm install
```
...
DB_USER=root
DB_PASSWORD=
DB_NAME=sahyadrikridamandal_db
DB_PORT=3306
...
| Platform | Link |
|----------|------|
| 🌐 **Location** | Bhaji Galli, Shankar Sheth Road, Grant Road, Mumbai — 400007 |
| 📧 **Email** | sahyadrikm.r@gmail.com |
| 📧 **Marketing** | sahyadrikm.r@gmail.com |
| 📞 **Helpline** | +91 93261 50793 |
| 📺 **YouTube** | [@sahyadrikridamandal.r](https://www.youtube.com/@sahyadrikridamandal.r) |
| 📸 **Instagram** | [@sahyadrikridamandal.r](https://www.instagram.com/sahyadrikridamandal.r/) |
| 📘 **Facebook** | [sahyadrikridamandal.r](https://www.facebook.com/sahyadrikridamandal.r) |

---

## 📄 License

ISC License. Built for **Sahyadri Krida Mandal**, Sahyadri, Mumbai.
