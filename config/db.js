...
const mockStore = {
  ...
  yatra_status: {
    current_day: 3,
    total_days: 10,
    current_location: 'Tilak Nagar Samaj Mandir Auditorium, Lokmanya Tilak Kridangan, Tilak Nagar, Chembur, Mumbai-400089 (Mandap Darshan Open)',
...
module.exports = {
  ...
  async updateDonationStatus(receiptNo, status) {
    ...
    try {
      ...
      return this.getDonationByReceipt(receiptNo);
    } catch (err) {
