...
const PAGE_SEO = {
  home: {
    path: '/',
    titleEn: 'Sahyadri Krida Mandal | Ganpati Mandal in Mumbai | Chembur',
    titleMr: 'सह्याद्री क्रीडा मंडळ | गणेशोत्सव मंडळ मुंबई | चेंबूर',
  ...
  about: {
    path: '/about',
    titleEn: 'About Sahyadri Krida Mandal | Ganeshotsav Mandal Mumbai',
    titleMr: 'आमच्याबद्दल | सह्याद्री क्रीडा मंडळ मुंबई इतिहास व सुवर्ण परंपरा',
  ...
  schedule: {
    path: '/schedule',
    titleEn: 'Ganpati Festival Schedule 2026 | Sahyadri Krida Mandal',
  ...
  glimpses: {
    path: '/glimpses',
    titleEn: 'Sahyadri Krida Mandal Glimpses | Ganpati Festival Mumbai',
    titleMr: 'सह्याद्री क्रीडा मंडळ क्षणचित्रे | गणपती देखावे फोटो गॅलरी मुंबई',
  ...
  socialwork: {
    path: '/social-work',
    titleEn: 'Sahyadri Krida Mandal Social Work | Mumbai Ganeshotsav',
    titleMr: 'सह्याद्री क्रीडा मंडळ सामाजिक कार्य | सेवा उपक्रम चेंबूर मुंबई',
  ...
  committee: {
    path: '/committee',
    titleEn: 'Sahyadri Krida Mandal Committee | Mumbai Ganpati Mandal',
    titleMr: 'सह्याद्री क्रीडा मंडळ कार्यकारिणी समिती | चेंबूर मुंबई पदाधिकारी',
  ...
  visitors: {
    path: '/visitors',
    titleEn: 'Visitors & Special Guests | Sahyadri Krida Mandal',
    titleMr: 'मान्यवर भेटी व विशेष अतिथी | सह्याद्री क्रीडा मंडळ चेंबूर मुंबई',
  ...
  advertisement: {
    path: '/advertisement',
    titleEn: 'Sahyadri Krida Mandal Advertisement | Mumbai Ganeshotsav',
    titleMr: 'उत्सव जाहिरात व प्रायोजकत्व | सह्याद्री क्रीडा मंडळ चेंबूर मुंबई',
  ...
  contact: {
    path: '/contact',
    titleEn: 'Contact Sahyadri Krida Mandal | Tilak Nagar, Chembur, Mumbai',
    titleMr: 'आमचे संपर्क व मंडप स्थान | सह्याद्री क्रीडा मंडळ टिळक नगर चेंबूर मुंबई',
  ...
  donate: {
    path: '/donate',
    titleEn: 'Donate to Sahyadri Krida Mandal | Ganpati Mandal Mumbai',
    titleMr: 'ऑनलाइन देणगी द्या (८०जी कर सवलत) | सह्याद्री क्रीडा मंडळ चेंबूर मुंबई',
