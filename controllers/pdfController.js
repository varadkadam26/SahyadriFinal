...
module.exports = {
  generateDonationPDF(donation, res) {
    ...
    // Header Box
    doc.rect(40, 40, 515, 105).fill('#4A0404');
    doc.fillColor('#FFD700').fontSize(16).font('Helvetica-Bold').text('SAHYADRI KRIDA MANDAL (TRUST)', 55, 48, { width: 485 });
    doc.fillColor('#FFFFFF').fontSize(10).font('Helvetica-Bold').text('Reg. No: F/7624 (Mumbai)  |  Est. 15th August 1976', 55, 68);
    doc.fillColor('#FDE68A').fontSize(8.5).font('Helvetica').text('Reg. Off: Next to Sahakar Plaza Cinema, Tilak Nagar, Mumbai - 400089', 55, 84);
    doc.fillColor('#FFC107').fontSize(8.5).font('Helvetica').text('Email: sahyadrikm.r@gmail.com  |  Website: www.sahyadrikridamandal.com', 55, 98);
    ...
    doc.fillColor('#94A3B8').fontSize(8).font('Helvetica').text('Ganpati Bappa Morya! Follow us on Instagram @sahyadrikridamandal.r', 40, 750, { align: 'center', width: 515 });
  ...
  generateTshirtPDF(order, res) {
    ...
    doc.fillColor('#FFD700').fontSize(18).font('Helvetica-Bold').text('SAHYADRI KRIDA MANDAL', 55, 52, { width: 485 });
    doc.fillColor('#FFFFFF').fontSize(14).font('Helvetica-Bold').text('OFFICIAL T-SHIRT & MERCHANDISE BOOKING TOKEN', 55, 85);
    doc.fillColor('#FFC107').fontSize(9).font('Helvetica').text('Reg Trust No:  | Instagram: @sahyadrikridamandal.r', 55, 106);

    // Main Receipt Body
    doc.rect(40, 155, 515, 340).lineWidth(1.5).strokeColor('#800020').stroke();

    doc.fillColor('#800020').fontSize(13).font('Helvetica-Bold').text('SAHYADRI KRIDA MANDAL OFFICIAL MERCHANDISE', 60, 172);
    doc.moveTo(60, 190).lineTo(535, 190).lineWidth(1).strokeColor('#FCD34D').stroke();
    ...
    const instructions = [
      ...
      '2. Pickup Address: Tulsiwadi Pandal, Tilak Nagar Samaj Mandir Auditorium, opposite Building 22, Lokmanya Tilak Kridangan, Tilak Nagar, Chembur, Mumbai - 400089.',
    ...
    doc.fillColor('#94A3B8').fontSize(8).font('Helvetica').text('Ganpati Bappa Morya! Sahyadri Krida Mandal', 40, 750, { align: 'center', width: 515 });
