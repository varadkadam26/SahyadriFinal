/**
 * Sahyadri Krida Mandal - Main Frontend Interactions
 * Libraries: GSAP, ScrollTrigger, Swiper.js
 * Official Mandal: Sahyadri Krida Mandal
 */
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.querySelectorAll('[data-lightbox]').forEach(item => {
    item.addEventListener('click', (e) => {
      ...
      const title = item.getAttribute(currentLang === 'mr' ? 'data-lightbox-title-mr' : 'data-lightbox-title-en') || item.getAttribute('data-lightbox-title') || 'Sahyadri Krida Mandal';
  ...
  // ==========================================================================
  // GANESHOTSAV 3D AAGMAN COUNTDOWN TIMER & CONFETTI CELEBRATION
  // Target: 12th September 2026, 5:00 PM IST (17:00 IST)
  // ==========================================================================
  const countdownTarget = new Date('2026-09-12T17:00:00+05:30').getTime();
  ...
  function animateCountdownUnit(key, value) {
    ...
    // Also update any mobile timer units
    document.querySelectorAll(`.mobile-count-val[data-timer="${key}"]`).forEach(mEl => {
      if (mEl.textContent !== value) {
    ...
    function goToSlide(index) {
      heroSlides.forEach((slide, i) => {
        if (i === index) {
          ...
          // Outgoing slide: add exiting class for the slide-out animation
          slide.classList.remove('active');
          slide.classList.add('exiting');
          // Remove exiting class after animation completes
          setTimeout(() => slide.classList.remove('exiting'), 1500);
        } else {
          slide.classList.remove('active');
          slide.classList.remove('exiting');
        }
  ...
  const timelineYearData = {
    '1976': {
      ...
      desc: 'सह्याद्री क्रीडा मंडळ येथील रहिवाशांनी एकत्र येऊन सार्वजनिक गणेशोत्सव मंडळाची स्थापना केली. अखंड भक्ती, परंपरा आणि सामाजिक ऐक्याचा ऐतिहासिक पाया १९७६ मध्ये रचला गेला.',
      image: '/images/sahyadri-ganpati-01.jpg',
      feat1: 'स्थापना: १९७६',
      feat2: 'स्थान: सह्याद्री क्रीडा मंडळ',
    ...
    '2024': {
      ...
      image: '/images/sahyadri-decoration-palace.jpg',
  ...
  const timelineYearDataEn = {
    '1976': {yearTag:'Year 1976', subhead:'Foundation Era', title:'Mandal Foundation & First Idol Installation', desc:'A foundation-era milestone celebrating the establishment of the public Ganeshotsav tradition of the mandal.', image:'/images/sahyadri-ganpati-01.jpg', feat1:'Founded: 1976', feat2:'Location: Tilak Nagar Samaj Mandir Auditorium, opposite Building 22, Lokmanya Tilak Kridangan, Tilak Nagar, Chembur, Mumbai - 400089', feat3:'Theme: Cultural Unity'},
    '2000': {yearTag:'Year 2000', subhead:'Seva Expansion', title:'Annadan Mahaprasad & Community Service', desc:'A milestone focused on community service, Annadan Mahaprasad and devotee support.', image:'/images/sahyadri-decoration-lights.jpg', feat1:'Seva: Annadan Mahaprasad', feat2:'Health: Support Camps', feat3:'Education: Student Aid'},
    '2015': {yearTag:'Year 2015', subhead:'Heritage Showcase', title:'Grand Royal Idol Presentation', desc:'A heritage-themed presentation of the idol with a traditional royal aesthetic.', image:'/images/sahyadri-ganpati-02.jpg', feat1:'Darshan: Grand Idol', feat2:'Craft: Traditional Artisans', feat3:'Decor: Royal Motifs'},
    '2020': {yearTag:'Year 2020', subhead:'Health & Seva', title:'Health Service & Community Support', desc:'A service-focused milestone highlighting health support and community care.', image:'/images/sahyadri-ganpati-01.jpg', feat1:'Service: Health Support', feat2:'Community: Seva', feat3:'Care: Devotee Assistance'},
    '2024': {yearTag:'Year 2024', subhead:'Golden Throne Adornment', title:'Golden Throne & Radiant Darshan', desc:'A grand darshan presentation featuring ornate adornment and a festive setting.', image:'/images/sahyadri-decoration-palace.jpg', feat1:'Throne: Ornate Craft', feat2:'Attire: Festive Adornment', feat3:'Darshan: Devotional Experience'},
    '2025': {yearTag:'Year 2025', subhead:'Royal Woodcraft & Digital Darshan', title:'Carved Throne & Digital Darshan Portal', desc:'A modern milestone combining traditional woodcraft aesthetics with digital darshan access.', image:'/images/sahyadri-decoration-temple.jpg', feat1:'Craft: Traditional Woodwork', feat2:'Digital: Live Darshan', feat3:'Seva: Online Support'}
  };
  ...
  if (nodeItems.length > 0) {
    nodeItems.forEach(item => {
      item.addEventListener('click', () => {
        ...
        const yearDetailsMr = {
          '2025': { title: 'काष्ठ सिंहासन व राजेशाही सुवर्ण शृंगार', theme: 'संकल्पना: Peshwa Era Palace Mandap Architecture', desc: 'पेशवाई नक्षीकामातील भव्य लाकडी सिंहासन आणि रेशमी पितांबर शृंगारातील १८ फुटी राजेशाही रूप दर्शन.', img: '/images/sahyadri-ganpati-01.jpg', badge: 'वर्ष २०२५' },
          '2024': { title: 'सुवर्ण सिंहासन व तेज:पुंज पीत पितांबर', theme: 'संकल्पना: Golden Temple Carvings & Lotus Arch', desc: 'हस्तकला नक्षीकामातील भव्य सुवर्ण सिंहासन आणि सुवर्ण मुकुटात विराजमान श्रींचे मनमोहक रूप.', img: '/images/sahyadri-ganpati-02.jpg', badge: 'वर्ष २०२४' },
          '2023': { title: 'मयूरपंख कमान आगमन सोहळा', theme: 'संकल्पना: Royal Heritage Court Decor', desc: 'मयुरासनी राजेशाही कमान आणि आगमन सोहळ्यातील श्रींचे भव्य रूप दर्शन.', img: '/images/sahyadri-decoration-palace.jpg', badge: 'वर्ष २०२३' },
          '2022': { title: 'श्री मुख दर्शन व सुवर्ण मुकुट', theme: 'संकल्पना: Tradition of Pure Devotion', desc: 'विलोभनीय हास्य, दिव्य नयन आणि सुवर्ण मुकुटातील १८ फुटी श्री मूर्ती रूप.', img: '/images/sahyadri-decoration-temple.jpg', badge: 'वर्ष २०२२' },
          '2021': { title: 'गर्भगृह पुष्प शृंगार दर्शन', theme: 'संकल्पना: Royal Velvet & Lotus Geometry', desc: '५०००+ ताजी फुले व जांभळ्या रेशमी पितांबरातील गर्भगृह शृंगार रूप.', img: '/images/sahyadri-decoration-cave.jpg', badge: 'वर्ष २०२१' },
          '2020': { title: 'आरोग्य संकल्प व सुवर्ण पदकमयी रूप', theme: 'संकल्पना: Arogya Seva & Blood Drive', desc: 'अखंड रक्तदान आणि आरोग्य शिबीरांच्या संकल्पातील सुवर्ण पदकमयी रूप.', img: '/images/sahyadri-decoration-lights.jpg', badge: 'वर्ष २०२०' },
          '2018': { title: 'राजवाडा महामंडप व सुवर्ण मेघडंबरी', theme: 'संकल्पना: Fort Raigad & Palace Architecture', desc: 'भव्य मराठा राजवाडा देखावा आणि सुवर्ण मेघडंबरीतील विलोभनीय रूप.', img: '/images/sahyadri-ganpati-01.jpg', badge: 'वर्ष २०१८' },
          '1976': { title: 'मंडळ स्थापना व प्रथम श्री स्थापना', theme: 'संकल्पना: Establishment & Sacred Foundation', desc: 'सह्याद्री क्रीडा मंडळ येथील रहिवाशांनी एकत्रित येऊन स्थापन केलेली श्रींची प्रथम प्रतिष्ठापना.', img: '/images/sahyadri-ganpati-02.jpg', badge: 'वर्ष १९७६' }
        };

        const yearDetailsEn = {
          '2025': { title: 'Wooden Throne & Royal Golden Adornment', theme: 'Theme: Peshwa Era Palace Mandap Architecture', desc: 'Grand 18-foot royal idol in carved wooden throne and silk pitambar adorned with Peshwai craftsmanship.', img: '/images/sahyadri-ganpati-01.jpg', badge: 'Year 2025' },
          '2024': { title: 'Golden Throne & Radiant Yellow Pitambar', theme: 'Theme: Golden Temple Carvings & Lotus Arch', desc: 'Grand golden throne carved by artisans, with the idol adorned in a golden crown — mesmerizing millions of devotees.', img: '/images/sahyadri-ganpati-02.jpg', badge: 'Year 2024' },
          '2023': { title: 'Peacock Feather Arch — Arrival Ceremony', theme: 'Theme: Royal Heritage Court Decor', desc: 'A grand peacock-throne arch and magnificent procession arrival form for the divine idol.', img: '/images/sahyadri-decoration-palace.jpg', badge: 'Year 2023' },
          '2022': { title: 'Divine Face & Golden Crown Darshan', theme: 'Theme: Tradition of Pure Devotion', desc: 'Enchanting smile, radiant eyes, and a golden crown — the 18-foot idol in full divine glory.', img: '/images/sahyadri-decoration-temple.jpg', badge: 'Year 2022' },
          '2021': { title: 'Sanctum Floral Adornment Darshan', theme: 'Theme: Royal Velvet & Lotus Geometry', desc: '5000+ fresh flowers and a royal purple silk pitambar — a breathtaking sanctum adornment.', img: '/images/sahyadri-decoration-cave.jpg', badge: 'Year 2021' },
          '2020': { title: 'Health Pledge & Golden Medallion Form', theme: 'Theme: Arogya Seva & Blood Drive', desc: 'Continuous blood donation and health camp seva — honoured with a golden medallion idol form.', img: '/images/sahyadri-decoration-lights.jpg', badge: 'Year 2020' },
          '2018': { title: 'Royal Mandap & Golden Canopy', theme: 'Theme: Fort Raigad & Palace Architecture', desc: 'Grand Maratha palace-style set and a breathtaking golden canopy mandap decor.', img: '/images/sahyadri-ganpati-01.jpg', badge: 'Year 2018' },
          '1976': { title: 'Mandal Founded & First Idol Consecration', theme: 'Theme: Establishment & Sacred Foundation', desc: 'Residents of Tilak Nagar Samaj Mandir Auditorium, opposite Building 22, Lokmanya Tilak Kridangan, Tilak Nagar, Chembur, Mumbai - 400089 united to establish the Sarvajanik Ganeshotsav Mandal and first divine installation.', img: '/images/sahyadri-ganpati-02.jpg', badge: 'Year 1976' }
        };
